...
.container .button {
  ...
  <body>
    <div class="logo">
      <a href="https://galilel.org/">
<!-- TODO: Letx fix this link @mbroemme -->
        <img src="https://galilel.org/logo@2x.png" title="Galilel Core"/>
      </a>
      </div>
    <div class="container">
        <img src="https://media.giphy.com/media/vIDsZm5DMZ5Ha/giphy.gif" title="Sad Explorer."/>
      <h1>Maintenance</h1>
      <p>Galilel Explorer is not available at this moment.<br/>Please check back later.</p><br/>
  <a href="https://galilel.org/" class="button">Back to Main</a>
      </div>
  </body>
</html>
  `);
